...
func (this *ILinearGradient) IID() *syscall.GUID {
	return &IID_ILinearGradient
}
...
func (this *ILinearGradient) GetCreator(rhs *int32) com.Error {
	addr := (*this.LpVtbl)[8]
	ret, _, _ := syscall.SyscallN(addr, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(rhs)))
	return com.Error(ret)
}
...
func (this *ILinearGradient) GetDegree(rhs *float64) com.Error {
	addr := (*this.LpVtbl)[11]
	ret, _, _ := syscall.SyscallN(addr, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(rhs)))
	return com.Error(ret)
}

func (this *ILinearGradient) SetDegree(rhs float64) com.Error {
	addr := (*this.LpVtbl)[12]
