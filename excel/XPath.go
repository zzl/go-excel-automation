...
func XPathFromVar(v ole.Variant) *XPath {
	return NewXPath(v.IDispatch(), false, false)
}
...
func (this *XPath) Map() *XmlMap {
	retVal, _ := this.PropGet(0x000008d6, nil)
...
func (this *XPath) SetValue(map_ *XmlMap, xpath string, optArgs ...interface{}) {
	...
	retVal, _ := this.Call(0x00000936, []interface{}{map_, xpath}, optArgs...)
	_ = retVal
}
...
func (this *XPath) Repeating() bool {
	retVal, _ := this.PropGet(0x00000938, nil)
