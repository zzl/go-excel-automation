...
func PicturesFromVar(v ole.Variant) *Pictures {
	return NewPictures(v.PdispValVal(), false, false)
}
...
func (this *Pictures) CopyPicture(appearance int32, format int32) ole.Variant {
...
func (this *Pictures) Add(left float64, top float64, width float64, height float64) *Picture {
	...
	return NewPicture(retVal.PdispValVal(), false, true)
}
...
func (this *Pictures) Insert(filename string, optArgs ...interface{}) *Picture {
	...
	retVal := this.Call(0x000000fc, []interface{}{filename}, optArgs...)
	return NewPicture(retVal.PdispValVal(), false, true)
}
