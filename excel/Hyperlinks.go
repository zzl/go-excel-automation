...
func (this *Hyperlinks) Add(anchor *ole.DispatchClass, address string, optArgs ...interface{}) *ole.DispatchClass {
	optArgs = ole.ProcessOptArgs(Hyperlinks_Add_OptArgs, optArgs)
	retVal := this.Call(0x000000b5, []interface{}{anchor, address}, optArgs...)
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}
