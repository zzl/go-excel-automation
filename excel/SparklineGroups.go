...
func SparklineGroupsFromVar(v ole.Variant) *SparklineGroups {
	return NewSparklineGroups(v.PdispValVal(), false, false)
}
...
func (this *SparklineGroups) Add(type_ int32, sourceData string) *SparklineGroup {
	retVal := this.Call(0x000000b5, []interface{}{type_, sourceData})
	return NewSparklineGroup(retVal.PdispValVal(), false, true)
}
...
func (this *SparklineGroups) ClearGroups()  {
	retVal := this.Call(0x00000b83, nil)
	_= retVal
}

func (this *SparklineGroups) Group(location *Range)  {
	retVal := this.Call(0x0000002e, []interface{}{location})
	_= retVal
}
