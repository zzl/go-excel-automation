...
func SlicerFromVar(v ole.Variant) *Slicer {
	return NewSlicer(v.PdispValVal(), false, false)
}
...
func (this *Slicer) DisableMoveResizeUI() bool {
	retVal := this.PropGet(0x00000ba7, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Slicer) SetDisableMoveResizeUI(rhs bool)  {
	retVal := this.PropPut(0x00000ba7, []interface{}{rhs})
	_= retVal
}
...
func (this *Slicer) NumberOfColumns() int32 {
	retVal := this.PropGet(0x00000ba8, nil)
	return retVal.LValVal()
}

func (this *Slicer) SetNumberOfColumns(rhs int32)  {
	retVal := this.PropPut(0x00000ba8, []interface{}{rhs})
	_= retVal
}

func (this *Slicer) DisplayHeader() bool {
	retVal := this.PropGet(0x00000ba9, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Slicer) SetDisplayHeader(rhs bool)  {
	retVal := this.PropPut(0x00000ba9, []interface{}{rhs})
	_= retVal
}
...
func (this *Slicer) ActiveItem() *SlicerItem {
	retVal := this.PropGet(0x00000bac, nil)
	return NewSlicerItem(retVal.PdispValVal(), false, true)
}
