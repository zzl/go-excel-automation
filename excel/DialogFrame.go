...
func DialogFrameFromVar(v ole.Variant) *DialogFrame {
	return NewDialogFrame(v.PdispValVal(), false, false)
}
...
func (this *DialogFrame) Dummy4_()  {
	retVal := this.Call(0x00010004, nil)
	_= retVal
}

func (this *DialogFrame) Dummy5_()  {
	retVal := this.Call(0x00010005, nil)
	_= retVal
}

func (this *DialogFrame) CopyPicture(appearance int32, format int32) ole.Variant {
...
func (this *DialogFrame) Dummy8_()  {
	retVal := this.Call(0x00010008, nil)
	_= retVal
}

func (this *DialogFrame) Dummy9_()  {
	retVal := this.Call(0x00010009, nil)
	_= retVal
}

func (this *DialogFrame) Dummy10_()  {
	retVal := this.Call(0x0001000a, nil)
	_= retVal
}
...
func (this *DialogFrame) Dummy17_()  {
	retVal := this.Call(0x00010011, nil)
	_= retVal
}
...
func (this *DialogFrame) Dummy20_()  {
	retVal := this.Call(0x00010014, nil)
	_= retVal
}
...
func (this *DialogFrame) Dummy25_()  {
	retVal := this.Call(0x00010019, nil)
	_= retVal
}
