...
func SparkAxesFromVar(v ole.Variant) *SparkAxes {
	return NewSparkAxes(v.PdispValVal(), false, false)
}
...
func (this *SparkAxes) Vertical() *SparkVerticalAxis {
	retVal := this.PropGet(0x00000b91, nil)
	return NewSparkVerticalAxis(retVal.PdispValVal(), false, true)
}

func (this *SparkAxes) Horizontal() *SparkHorizontalAxis {
	retVal := this.PropGet(0x00000b92, nil)
	return NewSparkHorizontalAxis(retVal.PdispValVal(), false, true)
}
