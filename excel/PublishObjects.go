...
func PublishObjectsFromVar(v ole.Variant) *PublishObjects {
	return NewPublishObjects(v.PdispValVal(), false, false)
}
...
func (this *PublishObjects) Add(sourceType int32, filename string, optArgs ...interface{}) *PublishObject {
	...
	retVal := this.Call(0x000000b5, []interface{}{sourceType, filename}, optArgs...)
	return NewPublishObject(retVal.PdispValVal(), false, true)
}
...
func (this *PublishObjects) Publish()  {
	retVal := this.Call(0x00000767, nil)
	_= retVal
}
