...
func DialogSheetFromVar(v ole.Variant) *DialogSheet {
	return NewDialogSheet(v.PdispValVal(), false, false)
}
...
func (this *DialogSheet) Dummy29_()  {
	retVal := this.Call(0x0001001d, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy69_()  {
	retVal := this.Call(0x00010045, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy74_()  {
	retVal := this.Call(0x0001004a, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy76_()  {
	retVal := this.Call(0x0001004c, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy78_()  {
	retVal := this.Call(0x0001004e, nil)
	_= retVal
}

func (this *DialogSheet) Dummy79_()  {
	retVal := this.Call(0x0001004f, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy82_()  {
	retVal := this.Call(0x00010052, nil)
	_= retVal
}

func (this *DialogSheet) Dummy83_()  {
	retVal := this.Call(0x00010053, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy85_()  {
	retVal := this.Call(0x00010055, nil)
	_= retVal
}

func (this *DialogSheet) Dummy86_()  {
	retVal := this.Call(0x00010056, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy88_()  {
	retVal := this.Call(0x00010058, nil)
	_= retVal
}

func (this *DialogSheet) Dummy89_()  {
	retVal := this.Call(0x00010059, nil)
	_= retVal
}

func (this *DialogSheet) Dummy90_()  {
	retVal := this.Call(0x0001005a, nil)
	_= retVal
}
...
func (this *DialogSheet) Dummy113_()  {
	retVal := this.Call(0x00010071, nil)
	_= retVal
}

func (this *DialogSheet) Dummy114_()  {
	retVal := this.Call(0x00010072, nil)
	_= retVal
}

func (this *DialogSheet) Dummy115_()  {
	retVal := this.Call(0x00010073, nil)
	_= retVal
}
...
func (this *DialogSheet) DialogFrame() *DialogFrame {
	retVal := this.PropGet(0x00000347, nil)
	return NewDialogFrame(retVal.PdispValVal(), false, true)
}
...
func (this *DialogSheet) EditBoxes(optArgs ...interface{}) *ole.DispatchClass {
	...
	retVal := this.Call(0x0000033c, nil, optArgs...)
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}

func (this *DialogSheet) Focus() ole.Variant {
	retVal := this.PropGet(0x0000032e, nil)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}

func (this *DialogSheet) SetFocus(rhs interface{})  {
	retVal := this.PropPut(0x0000032e, []interface{}{rhs})
	_= retVal
}
...
func (this *DialogSheet) Hide(optArgs ...interface{}) bool {
	...
	retVal := this.Call(0x0000032d, nil, optArgs...)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}
