...
var IID_IHPageBreaks = syscall.GUID{0x00024404, 0x0001, 0x0000, 
	[8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}

type IHPageBreaks struct {
	win32.IDispatch
}
...
func (this *IHPageBreaks) IID() *syscall.GUID {
	return &IID_IHPageBreaks
}
...
func (this *IHPageBreaks) GetCreator(rhs *int32) com.Error {
	addr := (*this.LpVtbl)[8]
	ret, _, _ := syscall.SyscallN(addr, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(rhs)))
	return com.Error(ret)
}
...
func (this *IHPageBreaks) GetCount(rhs *int32) com.Error {
	addr := (*this.LpVtbl)[10]
	ret, _, _ := syscall.SyscallN(addr, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(rhs)))
	return com.Error(ret)
}
