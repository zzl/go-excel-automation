...
func DatabarFromVar(v ole.Variant) *Databar {
	return NewDatabar(v.PdispValVal(), false, false)
}
...
func (this *Databar) MinPoint() *ConditionValue {
	retVal := this.PropGet(0x00000a9e, nil)
	return NewConditionValue(retVal.PdispValVal(), false, true)
}

func (this *Databar) MaxPoint() *ConditionValue {
	retVal := this.PropGet(0x00000a9f, nil)
	return NewConditionValue(retVal.PdispValVal(), false, true)
}

func (this *Databar) PercentMin() int32 {
	retVal := this.PropGet(0x00000aa0, nil)
	return retVal.LValVal()
}

func (this *Databar) SetPercentMin(rhs int32)  {
	retVal := this.PropPut(0x00000aa0, []interface{}{rhs})
	_= retVal
}

func (this *Databar) PercentMax() int32 {
	retVal := this.PropGet(0x00000aa1, nil)
	return retVal.LValVal()
}

func (this *Databar) SetPercentMax(rhs int32)  {
	retVal := this.PropPut(0x00000aa1, []interface{}{rhs})
	_= retVal
}

func (this *Databar) BarColor() *ole.DispatchClass {
	retVal := this.PropGet(0x00000aa2, nil)
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}
...
func (this *Databar) BarFillType() int32 {
	retVal := this.PropGet(0x00000b7d, nil)
	return retVal.LValVal()
}

func (this *Databar) SetBarFillType(rhs int32)  {
	retVal := this.PropPut(0x00000b7d, []interface{}{rhs})
	_= retVal
}

func (this *Databar) AxisPosition() int32 {
	retVal := this.PropGet(0x00000b7e, nil)
	return retVal.LValVal()
}

func (this *Databar) SetAxisPosition(rhs int32)  {
	retVal := this.PropPut(0x00000b7e, []interface{}{rhs})
	_= retVal
}

func (this *Databar) AxisColor() *ole.DispatchClass {
	retVal := this.PropGet(0x00000b7f, nil)
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}

func (this *Databar) BarBorder() *DataBarBorder {
	retVal := this.PropGet(0x00000b80, nil)
	return NewDataBarBorder(retVal.PdispValVal(), false, true)
}

func (this *Databar) NegativeBarFormat() *NegativeBarFormat {
	retVal := this.PropGet(0x00000b81, nil)
	return NewNegativeBarFormat(retVal.PdispValVal(), false, true)
}
