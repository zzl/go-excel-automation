...
func HPageBreaksFromVar(v ole.Variant) *HPageBreaks {
	return NewHPageBreaks(v.PdispValVal(), false, false)
}

func (this *HPageBreaks) IID() *syscall.GUID {
	return &IID_HPageBreaks
}

func (this *HPageBreaks) GetIDispatch(addRef bool) *win32.IDispatch {
	if addRef {
		this.AddRef()
	}
...
func (this *HPageBreaks) Release() uint32 {
...
func (this *HPageBreaks) Creator() int32 {
	retVal := this.PropGet(0x00000095, nil)
	return retVal.LValVal()
}

func (this *HPageBreaks) Parent() *ole.DispatchClass {
	retVal := this.PropGet(0x00000096, nil)
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}

func (this *HPageBreaks) Count() int32 {
	retVal := this.PropGet(0x00000076, nil)
	return retVal.LValVal()
}

func (this *HPageBreaks) Item(index int32) *HPageBreak {
	retVal := this.PropGet(0x000000aa, []interface{}{index})
	return NewHPageBreak(retVal.PdispValVal(), false, true)
}

func (this *HPageBreaks) Default_(index int32) *HPageBreak {
	retVal := this.PropGet(0x00000000, []interface{}{index})
	return NewHPageBreak(retVal.PdispValVal(), false, true)
}

func (this *HPageBreaks) NewEnum_() *com.UnknownClass {
	retVal := this.PropGet(-4, nil)
	return com.NewUnknownClass(retVal.PunkValVal(), true)
}

func (this *HPageBreaks) ForEach(action func(item *HPageBreak) bool) {
	pEnum := this.NewEnum_()
...
func (this *HPageBreaks) Add(before *ole.DispatchClass) *HPageBreak {
