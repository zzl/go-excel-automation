...
func (this *IShapes) GetParent(rhs **com.UnknownClass) com.Error {
	addr := (*this.LpVtbl)[9]
	ret, _, _ := syscall.SyscallN(addr, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(rhs)))
	if com.CurrentScope != nil {
		com.CurrentScope.Add(unsafe.Pointer(&(*rhs).IUnknown))
...
func (this *IShapes) GetNewEnum_(rhs **com.UnknownClass) com.Error {
	addr := (*this.LpVtbl)[13]
	ret, _, _ := syscall.SyscallN(addr, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(rhs)))
	if com.CurrentScope != nil {
		com.CurrentScope.Add(unsafe.Pointer(&(*rhs).IUnknown))
...
func (this *IShapes) AddSmartArt(layout *ole.DispatchClass, left interface{}, top interface{}, width interface{}, height interface{}, rhs **Shape) com.Error {
	addr := (*this.LpVtbl)[32]
