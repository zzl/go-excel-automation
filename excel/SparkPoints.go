...
func SparkPointsFromVar(v ole.Variant) *SparkPoints {
	return NewSparkPoints(v.IDispatch(), false, false)
}
...
func (this *SparkPoints) Negative() *SparkColor {
	retVal, _ := this.PropGet(0x00000b8b, nil)
	return NewSparkColor(retVal.IDispatch(), false, true)
}

func (this *SparkPoints) Markers() *SparkColor {
	retVal, _ := this.PropGet(0x00000b8c, nil)
	return NewSparkColor(retVal.IDispatch(), false, true)
}

func (this *SparkPoints) Highpoint() *SparkColor {
	retVal, _ := this.PropGet(0x00000b8d, nil)
	return NewSparkColor(retVal.IDispatch(), false, true)
}

func (this *SparkPoints) Lowpoint() *SparkColor {
	retVal, _ := this.PropGet(0x00000b8e, nil)
	return NewSparkColor(retVal.IDispatch(), false, true)
}

func (this *SparkPoints) Firstpoint() *SparkColor {
	retVal, _ := this.PropGet(0x00000b8f, nil)
	return NewSparkColor(retVal.IDispatch(), false, true)
}

func (this *SparkPoints) Lastpoint() *SparkColor {
	retVal, _ := this.PropGet(0x00000b90, nil)
	return NewSparkColor(retVal.IDispatch(), false, true)
}
