...
func VPageBreaksFromVar(v ole.Variant) *VPageBreaks {
	return NewVPageBreaks(v.IDispatch(), false, false)
}
...
func (this *VPageBreaks) Item(index int32) *VPageBreak {
	...
	return NewVPageBreak(retVal.IDispatch(), false, true)
}
...
func (this *VPageBreaks) Add(before *win32.IUnknown) *VPageBreak {
