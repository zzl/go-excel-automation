...
func PivotLineFromVar(v ole.Variant) *PivotLine {
	return NewPivotLine(v.PdispValVal(), false, false)
}
...
func (this *PivotLine) LineType() int32 {
	retVal := this.PropGet(0x00000a7b, nil)
	return retVal.LValVal()
}
...
func (this *PivotLine) PivotLineCells() *PivotLineCells {
	retVal := this.PropGet(0x00000a7c, nil)
	return NewPivotLineCells(retVal.PdispValVal(), false, true)
}
