...
func (this *Hyperlink) SubAddress() string {
	retVal := this.PropGet(0x000005bf, nil)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Hyperlink) SetSubAddress(rhs string)  {
	retVal := this.PropPut(0x000005bf, []interface{}{rhs})
	_= retVal
}

func (this *Hyperlink) Address() string {
	retVal := this.PropGet(0x000000ec, nil)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Hyperlink) SetAddress(rhs string)  {
	retVal := this.PropPut(0x000000ec, []interface{}{rhs})
	_= retVal
}
...
func (this *Hyperlink) Follow(optArgs ...interface{})  {
	...
	retVal := this.Call(0x00000650, nil, optArgs...)
	_= retVal
}

func (this *Hyperlink) EmailSubject() string {
	retVal := this.PropGet(0x0000075b, nil)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Hyperlink) SetEmailSubject(rhs string)  {
	retVal := this.PropPut(0x0000075b, []interface{}{rhs})
	_= retVal
}

func (this *Hyperlink) ScreenTip() string {
	retVal := this.PropGet(0x00000759, nil)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Hyperlink) SetScreenTip(rhs string)  {
	retVal := this.PropPut(0x00000759, []interface{}{rhs})
	_= retVal
}

func (this *Hyperlink) TextToDisplay() string {
	retVal := this.PropGet(0x0000075a, nil)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Hyperlink) SetTextToDisplay(rhs string)  {
	retVal := this.PropPut(0x0000075a, []interface{}{rhs})
	_= retVal
}

func (this *Hyperlink) CreateNewDocument(filename string, editNow bool, overwrite bool)  {
	retVal := this.Call(0x0000075c, []interface{}{filename, editNow, overwrite})
	_= retVal
}
