...
func ChartObjectsFromVar(v ole.Variant) *ChartObjects {
	return NewChartObjects(v.PdispValVal(), false, false)
}
...
func (this *ChartObjects) CopyPicture(appearance int32, format int32) ole.Variant {
...
func (this *ChartObjects) Add(left float64, top float64, width float64, height float64) *ChartObject {
	...
	return NewChartObject(retVal.PdispValVal(), false, true)
}
