...
func PivotFormulasFromVar(v ole.Variant) *PivotFormulas {
	return NewPivotFormulas(v.PdispValVal(), false, false)
}
...
func (this *PivotFormulas) Add_(formula string) *PivotFormula {
	retVal := this.Call(0x00000825, []interface{}{formula})
	return NewPivotFormula(retVal.PdispValVal(), false, true)
}
...
func (this *PivotFormulas) Add(formula string, optArgs ...interface{}) *PivotFormula {
	...
	retVal := this.Call(0x000000b5, []interface{}{formula}, optArgs...)
	return NewPivotFormula(retVal.PdispValVal(), false, true)
}
