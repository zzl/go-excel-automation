...
func ScenariosFromVar(v ole.Variant) *Scenarios {
	return NewScenarios(v.IDispatch(), false, false)
}
...
func (this *Scenarios) Add(name string, changingCells interface{}, optArgs ...interface{}) *Scenario {
	...
	retVal, _ := this.Call(0x000000b5, []interface{}{name, changingCells}, optArgs...)
	return NewScenario(retVal.IDispatch(), false, true)
}
...
func (this *Scenarios) CreateSummary(optArgs ...interface{}) ole.Variant {
	...
	retVal, _ := this.Call(0x00000391, nil, optArgs...)
...
func (this *Scenarios) Merge(source interface{}) ole.Variant {
	retVal, _ := this.Call(0x00000234, []interface{}{source})
	com.AddToScope(retVal)
	return *retVal
}
