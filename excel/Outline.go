...
func OutlineFromVar(v ole.Variant) *Outline {
	return NewOutline(v.PdispValVal(), false, false)
}
...
func (this *Outline) AutomaticStyles() bool {
	retVal := this.PropGet(0x000003bf, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Outline) SetAutomaticStyles(rhs bool)  {
	retVal := this.PropPut(0x000003bf, []interface{}{rhs})
	_= retVal
}
...
func (this *Outline) ShowLevels(optArgs ...interface{}) ole.Variant {
	...
	retVal := this.Call(0x000003c0, nil, optArgs...)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}

func (this *Outline) SummaryColumn() int32 {
	retVal := this.PropGet(0x000003c1, nil)
	return retVal.LValVal()
}

func (this *Outline) SetSummaryColumn(rhs int32)  {
	retVal := this.PropPut(0x000003c1, []interface{}{rhs})
	_= retVal
}

func (this *Outline) SummaryRow() int32 {
	retVal := this.PropGet(0x00000386, nil)
	return retVal.LValVal()
}

func (this *Outline) SetSummaryRow(rhs int32)  {
	retVal := this.PropPut(0x00000386, []interface{}{rhs})
	_= retVal
}
