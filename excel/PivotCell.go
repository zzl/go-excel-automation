...
func PivotCellFromVar(v ole.Variant) *PivotCell {
	return NewPivotCell(v.PdispValVal(), false, false)
}
...
func (this *PivotCell) PivotCellType() int32 {
	retVal := this.PropGet(0x0000088d, nil)
	return retVal.LValVal()
}
...
func (this *PivotCell) RowItems() *PivotItemList {
	retVal := this.PropGet(0x0000088e, nil)
	return NewPivotItemList(retVal.PdispValVal(), false, true)
}

func (this *PivotCell) ColumnItems() *PivotItemList {
	retVal := this.PropGet(0x0000088f, nil)
	return NewPivotItemList(retVal.PdispValVal(), false, true)
}
