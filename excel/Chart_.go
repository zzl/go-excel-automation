...
func Chart_FromVar(v ole.Variant) *Chart_ {
	return NewChart_(v.PdispValVal(), false, false)
}
...
func (this *Chart_) ApplyDataLabels_(type_ int32, optArgs ...interface{})  {
...
func (this *Chart_) AutoFormat(gallery int32, optArgs ...interface{})  {
	...
	retVal := this.Call(0x00000072, []interface{}{gallery}, optArgs...)
	_= retVal
}
...
func (this *Chart_) Axes(type_ interface{}, axisGroup int32) *ole.DispatchClass {
	retVal := this.Call(0x00000017, []interface{}{type_, axisGroup})
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}
...
func (this *Chart_) ChartWizard(optArgs ...interface{})  {
	...
	retVal := this.Call(0x000000c4, nil, optArgs...)
	_= retVal
}
...
func (this *Chart_) CopyPicture(appearance int32, format int32, size int32)  {
	retVal := this.Call(0x000000d5, []interface{}{appearance, format, size})
	_= retVal
}
...
func (this *Chart_) CreatePublisher(edition interface{}, appearance int32, size int32, optArgs ...interface{})  {
	optArgs = ole.ProcessOptArgs(Chart__CreatePublisher_OptArgs, optArgs)
	retVal := this.Call(0x000001ca, []interface{}{edition, appearance, size}, optArgs...)
	_= retVal
}

func (this *Chart_) DataTable() *DataTable {
	retVal := this.PropGet(0x00000573, nil)
...
func (this *Chart_) Deselect()  {
	retVal := this.Call(0x00000460, nil)
	_= retVal
}
...
func (this *Chart_) HasAxis(optArgs ...interface{}) ole.Variant {
	...
	retVal := this.PropGet(0x00000034, nil, optArgs...)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}
...
func (this *Chart_) SetHasAxis(index1 interface{}, optArgs ...interface{})  {
	optArgs = ole.ProcessOptArgs(Chart__SetHasAxis_OptArgs, optArgs)
	retVal := this.PropPut(0x00000034, []interface{}{index1}, optArgs...)
	_= retVal
}
...
func (this *Chart_) Location(where int32, optArgs ...interface{}) *Chart {
	...
	retVal := this.Call(0x00000575, []interface{}{where}, optArgs...)
...
func (this *Chart_) ShowWindow() bool {
	retVal := this.PropGet(0x00000577, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Chart_) SetShowWindow(rhs bool)  {
	retVal := this.PropPut(0x00000577, []interface{}{rhs})
	_= retVal
}
...
func (this *Chart_) CopyChartBuild()  {
	retVal := this.Call(0x0000057c, nil)
	_= retVal
}

func (this *Chart_) ProtectFormatting() bool {
	retVal := this.PropGet(0x0000057d, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Chart_) SetProtectFormatting(rhs bool)  {
	retVal := this.PropPut(0x0000057d, []interface{}{rhs})
	_= retVal
}

func (this *Chart_) ProtectData() bool {
	retVal := this.PropGet(0x0000057e, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Chart_) SetProtectData(rhs bool)  {
	retVal := this.PropPut(0x0000057e, []interface{}{rhs})
	_= retVal
}

func (this *Chart_) ProtectGoalSeek() bool {
	retVal := this.PropGet(0x0000057f, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Chart_) SetProtectGoalSeek(rhs bool)  {
	retVal := this.PropPut(0x0000057f, []interface{}{rhs})
	_= retVal
}

func (this *Chart_) ProtectSelection() bool {
	retVal := this.PropGet(0x00000580, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Chart_) SetProtectSelection(rhs bool)  {
	retVal := this.PropPut(0x00000580, []interface{}{rhs})
	_= retVal
}
...
func (this *Chart_) Export(filename string, optArgs ...interface{}) bool {
	...
	retVal := this.Call(0x00000586, []interface{}{filename}, optArgs...)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}
...
func (this *Chart_) PivotLayout() *PivotLayout {
	...
	return NewPivotLayout(retVal.PdispValVal(), false, true)
}
...
func (this *Chart_) ApplyDataLabels(type_ int32, optArgs ...interface{})  {
...
func (this *Chart_) ApplyLayout(layout int32, optArgs ...interface{})  {
	...
	retVal := this.Call(0x000009c4, []interface{}{layout}, optArgs...)
	_= retVal
}

func (this *Chart_) SetElement(element int32)  {
	retVal := this.Call(0x000009c6, []interface{}{element})
	_= retVal
}

func (this *Chart_) ShowDataLabelsOverMaximum() bool {
	retVal := this.PropGet(0x000009c8, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Chart_) SetShowDataLabelsOverMaximum(rhs bool)  {
	retVal := this.PropPut(0x000009c8, []interface{}{rhs})
	_= retVal
}

func (this *Chart_) SideWall() *Walls {
	retVal := this.PropGet(0x000009c9, nil)
	return NewWalls(retVal.PdispValVal(), false, true)
}

func (this *Chart_) BackWall() *Walls {
	retVal := this.PropGet(0x000009ca, nil)
	return NewWalls(retVal.PdispValVal(), false, true)
}
...
func (this *Chart_) ApplyChartTemplate(filename string)  {
	retVal := this.Call(0x000009cb, []interface{}{filename})
	_= retVal
}

func (this *Chart_) SaveChartTemplate(filename string)  {
	retVal := this.Call(0x000009cc, []interface{}{filename})
	_= retVal
}

func (this *Chart_) SetDefaultChart(name interface{})  {
	retVal := this.Call(0x000000db, []interface{}{name})
	_= retVal
}
...
func (this *Chart_) ChartStyle() ole.Variant {
	retVal := this.PropGet(0x000009cd, nil)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}

func (this *Chart_) SetChartStyle(rhs interface{})  {
	retVal := this.PropPut(0x000009cd, []interface{}{rhs})
	_= retVal
}

func (this *Chart_) ClearToMatchStyle()  {
	retVal := this.Call(0x000009ce, nil)
	_= retVal
}
