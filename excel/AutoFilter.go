...
func AutoFilterFromVar(v ole.Variant) *AutoFilter {
	return NewAutoFilter(v.PdispValVal(), false, false)
}
...
func (this *AutoFilter) Filters() *Filters {
	retVal := this.PropGet(0x00000651, nil)
	return NewFilters(retVal.PdispValVal(), false, true)
}
...
func (this *AutoFilter) ApplyFilter()  {
	retVal := this.Call(0x00000a50, nil)
	_= retVal
}
