...
var IID_LinearGradient = syscall.GUID{0x000244AF, 0x0000, 0x0000, 
...
func (this *LinearGradient) IID() *syscall.GUID {
	return &IID_LinearGradient
}

func (this *LinearGradient) GetIDispatch(addRef bool) *win32.IDispatch {
	if addRef {
		this.AddRef()
	}
