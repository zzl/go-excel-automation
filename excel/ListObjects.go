...
func ListObjectsFromVar(v ole.Variant) *ListObjects {
	return NewListObjects(v.PdispValVal(), false, false)
}
...
func (this *ListObjects) Add_(sourceType int32, source interface{}, linkSource interface{}, xlListObjectHasHeaders int32, optArgs ...interface{}) *ListObject {
	optArgs = ole.ProcessOptArgs(ListObjects_Add__OptArgs, optArgs)
	retVal := this.Call(0x00000825, []interface{}{sourceType, source, linkSource, xlListObjectHasHeaders}, optArgs...)
...
func (this *ListObjects) Add(sourceType int32, source interface{}, linkSource interface{}, xlListObjectHasHeaders int32, optArgs ...interface{}) *ListObject {
	optArgs = ole.ProcessOptArgs(ListObjects_Add_OptArgs, optArgs)
	retVal := this.Call(0x000000b5, []interface{}{sourceType, source, linkSource, xlListObjectHasHeaders}, optArgs...)
	return NewListObject(retVal.PdispValVal(), false, true)
}
