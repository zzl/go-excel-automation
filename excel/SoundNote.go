...
func SoundNoteFromVar(v ole.Variant) *SoundNote {
	return NewSoundNote(v.PdispValVal(), false, false)
}
...
func (this *SoundNote) Import(filename string) ole.Variant {
	retVal := this.Call(0x00000395, []interface{}{filename})
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}

func (this *SoundNote) Play() ole.Variant {
	retVal := this.Call(0x00000396, nil)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}

func (this *SoundNote) Record() ole.Variant {
	retVal := this.Call(0x00000397, nil)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}
