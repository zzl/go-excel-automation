...
func SpeechFromVar(v ole.Variant) *Speech {
	return NewSpeech(v.IDispatch(), false, false)
}
...
func (this *Speech) Speak(text string, optArgs ...interface{}) {
	...
	retVal, _ := this.Call(0x000007e1, []interface{}{text}, optArgs...)
	_ = retVal
}
...
func (this *Speech) SpeakCellOnEnter() bool {
	retVal, _ := this.PropGet(0x000008bb, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}

func (this *Speech) SetSpeakCellOnEnter(rhs bool) {
	_ = this.PropPut(0x000008bb, []interface{}{rhs})
}
