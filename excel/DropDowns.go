...
func DropDownsFromVar(v ole.Variant) *DropDowns {
	return NewDropDowns(v.PdispValVal(), false, false)
}
...
func (this *DropDowns) CopyPicture(appearance int32, format int32) ole.Variant {
...
func (this *DropDowns) SetList(index interface{}, optArgs ...interface{})  {
...
func (this *DropDowns) SetSelected(index interface{}, optArgs ...interface{})  {
...
func (this *DropDowns) Add(left float64, top float64, width float64, height float64, optArgs ...interface{}) *DropDown {
	...
	retVal := this.Call(0x000000b5, []interface{}{left, top, width, height}, optArgs...)
